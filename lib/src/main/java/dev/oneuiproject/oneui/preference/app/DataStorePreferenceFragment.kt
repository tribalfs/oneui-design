 ...
 */
abstract class ObservablePreferencesDataStore : PreferenceDataStore() {
    ...
    /**
     * The concrete implementation must provide its [DataStore<Preferences>] instance.
     */
    ...
    override fun putInt(key: String, value: Int) {
        ...
        scope.launch { dataStore().edit { it[k] = value } }
    }
    ...
    override fun putStringSet(key: String, values: Set<String>?) {
        ...
        scope.launch { dataStore().edit { it[k] = values ?: emptySet() } }
    }
